    ...
    <section id="skills" className="py-8 scroll-mt-16">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-6">
          <span
            className="inline-block font-mono bg-gray-50 dark:bg-gray-800 px-2 py-1 rounded text-xs text-light-text-secondary dark:text-gray-400 border border-light-border dark:border-gray-700"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {skillCategories.map((category, index) => (
            <div key={index} className="bg-light-card dark:bg-gray-800 rounded-lg shadow-sm p-3 border border-light-border dark:border-gray-700">
              ...
              <div className="flex flex-wrap gap-1.5">
                {category.skills.map((skill, skillIndex) => (
                  <span
                    key={skillIndex}
                    className="px-2 py-0.5 bg-gray-50 dark:bg-gray-700 text-light-text-secondary dark:text-gray-200 rounded text-xs border border-gray-100 dark:border-gray-600"
                  >
                    {skill}
                  </span>
                ))}
