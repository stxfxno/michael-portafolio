...
const Hero = () => {
  ...
  return (
    <section id="home" className="py-12 md:py-24">
      {/* Container para mantener consistencia con otras secciones */}
      <div className="max-w-6xl mx-auto px-4">
        {/* Grid mejorado para responsive */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          {/* Información (primera en móvil, segunda en desktop) */}
          <div className="order-2 lg:order-1">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <div className="flex items-center bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded-lg">
                ...
                <span className="text-gray-700 dark:text-gray-300">8+ Proyectos</span>
              </div>
              <div className="flex items-center bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded-lg">
