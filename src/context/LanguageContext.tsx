...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'experience.job1.period': 'Feb - Sep 2025 · Ene 2026 - Presente',
    ...
    'experience.job4.desc1': 'Desarrollé la página web corporativa y una plataforma integral para la empresa de transporte, incluyendo monitoreo GPS de trailers, gestión financiera y calendario de pagos.',
    'experience.job4.desc2': 'Implementé módulos de control operativo de flota en tiempo real, centralizando los servicios clave de la empresa en una sola plataforma.',
  ...
  en: {
    ...
    'experience.job1.company': 'Sprinta AI',
    'experience.job1.period': 'Feb - Sep 2025 · Jan 2026 - Present',
    ...
    'experience.job4.desc1': 'Built the corporate website and a comprehensive platform for the transport company, including real-time GPS trailer tracking, financial management, and payment scheduling.',
    'experience.job4.desc2': 'Implemented fleet operational control modules, centralizing the company\'s key services into a single platform.',
